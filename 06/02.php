...
class Store
{
    ...
    public function create($storeName, $initialStock)
    {
        $this->name = $storeName;
...
$alex_branch = new Store;

echo '<pre>';

$alex_branch->create('Alex', 5000);
...
$alrehab_branch = new Store;

$alrehab_branch->create('Alrehab', 10000);
